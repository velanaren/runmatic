...
**Claude generates SCORE.md only.** Vela writes README.md, commands.sh, and notes.md herself. This is intentional — Vela documenting her own understanding is where learning consolidates.
...
**README.md** — Vela's understanding of the concept, in her own words. Format:
```markdown
# Sprint [XX] — [Topic]

## The Mental Model That Made It Click
[Your analogy — how you understood it before you ran any commands]

## What I Built
[One sentence: the concrete deliverable and done condition]

## The Mistake I Made (and What It Taught Me)
[The actual mistake from Phase 2 or Phase 3 — be specific and honest.
This section is the most valuable thing in the repo for anyone reading it.]

## What I'd Do Differently
[One sentence — shows reflection and growth mindset]

## Connection to Real Systems
[One sentence — where does this concept matter in production]
```

**commands.sh** — Every command run during the sprint, in order, as a narrative runbook:
```bash
#!/bin/bash
# Sprint [XX] — [Topic]
...
**notes.md** — For sprints with no infrastructure file (conceptual/observation sprints):
```markdown
# Sprint [XX] — [Topic] — Observation Notes

## Commands I Ran and What I Actually Observed
[Each command, what you expected, what you actually got, what surprised you]

## Mental Model Before vs After
Before this sprint I thought: [your prior understanding]
After this sprint I understand: [corrected/deepened understanding]

## Questions This Raised
[Things you're now curious about — shows intellectual engagement]
```

### Sprint folder contents summary

| Sprint type | infra file | README.md | commands.sh | notes.md | SCORE.md |
|------------|-----------|-----------|------------|---------|---------|
| Conceptual (01, 02, 13) | ❌ | ✅ Vela | ✅ Vela | ✅ Vela | ✅ Claude |
| Build sprint (03–11, 14–31) | ✅ Vela | ✅ Vela | ✅ Vela | ❌ | ✅ Claude |
| Capstone (12, 20, 32) | ✅ Vela | ✅ Vela | ✅ Vela | ✅ Vela | ✅ Claude |
